...
internal class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        Option<FileInfo?> ConfigOption = new("--config")
        {
            ...
            DefaultValueFactory = parseResult => new FileInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "config.json"))
        };
        ...
        var ForceDownloadOption = new Option<bool>("--force")
        {
        ...
        var configpathOption = new Option<FileInfo?>("--path")
        {
